...
void main()
{
	...
	Human human("Иванов", "Иван", 18);
	human.print();

	Student student("Pinkman", "Jessy", 20, "Chemistry", "WW_121", 90, 85);
	student.print();

	Teacher teacher("White", "Walter", 50, "Chemistry", 20);
	teacher.print();

	Graduate graduate("Shrader", "Hank", 40, "Criminalistic", "WW_121", 95, 65, "How to catch Heisenberg");
	graduate.print();
}